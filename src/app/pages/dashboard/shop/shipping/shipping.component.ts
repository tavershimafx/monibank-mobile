...
export class ShippingComponent implements OnInit{
  ...
  shippingForm: FormGroup = new FormGroup({
    "nameOnCard": new FormControl('', Validators.compose([Validators.required])),
    "cardNumber": new FormControl('', Validators.compose([Validators.required])),
    "cardMonth": new FormControl('', Validators.compose([Validators.required])),
    "cardYear": new FormControl('', Validators.compose([Validators.required])),
  ...
  pay(){
    ...
    this.isLoading = true
   setTimeout(() => {
    this.httpClient.post(`${BASE_URL}/pay?uid=${this.user.id}`, this.shippingForm.value).subscribe({
      next: (e) =>{
